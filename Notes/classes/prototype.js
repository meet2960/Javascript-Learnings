...
// ? Here we have added new property inside Object level, this means now every object, array etc have access to this customProperty
Object.prototype.customProperty = function () {
  console.log("Meet is Present in all Object");
};

// ? Here we have only given this new property to Array only, means now only Array has access to this proerty, but object, string have no access
...
// ? This is modern method and behind the seen it works like __proto__ only. It takes two parameters, from object - to object. From which object To which object we have to assign properties
